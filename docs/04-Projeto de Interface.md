...
|  Critérios de Êxito   | O resultado será considerado satisfatório quando:<br>_ O sistema reportar mensagem de confirmação de realização do cadastro;<br>_ O sistema direcionar automaticamente o usuário para tela de login.                                                                                                              |
...
|  Critérios de Êxito   | O resultado será considerado satisfatório quando:<br>_ O sistema direcionar automaticamente o usuário para tela de gestão do estabelecimento;<br>_ O sistema reportar mensagem de confirmação de realização do cadastro.                                                                                                                                            |
